...
export const metadata: Metadata = {
    ...
    description: "Shop CrossFit Barbells. Best prices and reviews.",
};
    ...
    const products = [
        {
            ...
            features: ["28mm shaft", "WOD ready", "Bushing"],
        ...
        },
        {
            ...
            features: ["28mm shaft", "Hybrid knurl", "Ceramic coating"],
            affiliate: "https://trugritfitness.pxf.io/Z6PKV1"
        },
        {
            name: "Rep Fracture Bar",
            brand: "Rep",
            price: "$225",
            rating: 4.7,
            reviews: 890,
            image: "https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=800&q=80",
            features: ["28mm shaft", "Durable", "Good value"],
            affiliate: "https://trugritfitness.pxf.io/Z6PKV1"
        }
    ];
            ...
            <main className="min-h-screen bg-gray-50">
                <section className="bg-gradient-to-r from-orange-900 to-orange-800 text-white py-20">
                    <div className="max-w-7xl mx-auto px-4">
                        ...
                        <p className="text-xl md:text-2xl text-orange-200 mb-8">SUBCrossFit Barbells</p>
                            ...
                            {products.map((product, index) => (
                                <div key={index} className="bg-white rounded-2xl shadow-xl overflow-hidden hover:shadow-2xl transition-all">
                                    <div className="relative h-64">
                                        ...
                                        <div className="absolute top-4 right-4 bg-orange-600 text-white px-3 py-1 rounded-full text-sm">{product.brand}</div>
                                    </div>
                                    <div className="p-6">
                                        ...
                                        <div className="flex items-center justify-between mt-4 pt-4 border-t">
                                            ...
                                            <a href={product.affiliate} target="_blank" className="bg-orange-600 hover:bg-orange-700 text-white px-6 py-2 rounded-lg font-bold">View Deal</a>
                                        </div>
                                    </div>
                                </div>
                            ))}
                ...
                <section className="bg-white py-16">
                    <div className="max-w-7xl mx-auto px-4">
                        <h2 className="text-3xl font-bold text-gray-800 mb-8 text-center">Why Choose CrossFit Barbells?</h2>
                        <div className="grid md:grid-cols-3 gap-8">
                            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-8 rounded-2xl text-center">
                                <div className="text-4xl mb-4">🏋️</div>
                                <h3 className="text-xl font-bold text-orange-800 mb-2">Performance</h3>
                                <p className="text-gray-600">Premium materials and precision manufacturing.</p>
                            </div>
                            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-8 rounded-2xl text-center">
                                <div className="text-4xl mb-4">💪</div>
                                <h3 className="text-xl font-bold text-orange-800 mb-2">Durability</h3>
                                <p className="text-gray-600">Built to last with quality steel.</p>
                            </div>
                            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-8 rounded-2xl text-center">
                                <div className="text-4xl mb-4">⭐</div>
                                <h3 className="text-xl font-bold text-orange-800 mb-2">Value</h3>
