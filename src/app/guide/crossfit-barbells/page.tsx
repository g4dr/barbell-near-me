            ...
            <main className="min-h-screen bg-gray-50">
                <section className="bg-gradient-to-r from-orange-900 to-orange-800 text-white py-16">
                    <div className="max-w-7xl mx-auto px-4">
                        <h1 className="text-4xl md:text-5xl font-bold mb-4">CrossFit Barbell Guide</h1>
                        <p className="text-xl text-orange-200 mb-6">Expert guide to finding your perfect barbell.</p>
                    </div>
                </section>
