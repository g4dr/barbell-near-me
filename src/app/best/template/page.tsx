...
export default function PAGENAMEPage() {
  const products = [
    { name: 'Rogue PRODUCT1', brand: 'Rogue', price: '$XXX', rating: 4.9, reviews: 1000, features: ['Feature1', 'Feature2'] },
    { name: 'Eleiko PRODUCT1', brand: 'Eleiko', price: '$XXX', rating: 5.0, reviews: 500, features: ['Premium', 'Competition'] },
    { name: 'Rep PRODUCT1', brand: 'Rep', price: '$XXX', rating: 4.7, reviews: 300, features: ['Value', 'Quality'] },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      <section className="bg-gradient-to-r from-purple-900 to-purple-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-xl text-purple-200 mb-6">PAGEDESC</p>
        </div>
      </section>
      ...
      <section className="bg-white py-12">
        <div className="max-w-7xl mx-auto px-4">
          <h2 className="text-3xl font-bold text-gray-800 mb-6">Why Choose PAGETITLE</h2>
          <div className="grid md:grid-cols-3 gap-6">
      ...
      <section className="bg-gradient-to-r from-purple-600 to-purple-800 text-white py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Shop PAGETITLE</h2>
