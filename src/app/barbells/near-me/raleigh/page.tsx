...
export const metadata: Metadata = {
  title: "Raleigh Barbells - Buy Weightlifting Equipment in Raleigh | BarbellNearMe",
  description: "Find the best barbells and gym equipment in Raleigh. Browse Olympic bars, powerlifting bars, and fitness gear. Local delivery available. Shop now!",
};
    ...
    <div className="min-h-screen bg-gray-50">
      <section className="bg-gradient-to-r from-purple-900 to-purple-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Raleigh Barbells</h1>
          <p className="text-xl text-purple-200 mb-6">Buy premium weightlifting equipment in Raleigh. Fast local delivery available.</p>
        </div>
      </section>
      ...
      <section className="bg-gradient-to-r from-purple-600 to-purple-800 text-white py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Shop in Raleigh</h2>
