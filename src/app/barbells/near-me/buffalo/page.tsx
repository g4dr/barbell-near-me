...
export const metadata: Metadata = {
  title: "Buffalo Barbells - Buy Weightlifting Equipment in Buffalo | BarbellNearMe",
  description: "Find the best barbells and gym equipment in Buffalo. Browse Olympic bars, powerlifting bars, and fitness gear. Local delivery available. Shop now!",
};
    ...
    <div className="min-h-screen bg-gray-50">
      <section className="bg-gradient-to-r from-purple-900 to-purple-800 text-white py-16">
        <div className="max-w-7xl mx-auto px-4">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Buffalo Barbells</h1>
          <p className="text-xl text-purple-200 mb-6">Buy premium weightlifting equipment in Buffalo. Fast local delivery available.</p>
        </div>
      </section>
      ...
      <nav className="bg-white border-b py-3">
        <div className="max-w-7xl mx-auto px-4 text-sm">
          ...
          <span className="mx-2 text-gray-400">/</span>
          <span className="text-gray-600">Buffalo</span>
        </div>
      </nav>
      ...
      <section className="bg-gradient-to-r from-purple-600 to-purple-800 text-white py-12">
        <div className="max-w-4xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold mb-4">Shop in Buffalo</h2>
