...
export const metadata: Metadata = {
    title: "Tucson Barbells | BarbellNearMe",
    description: "Find the best barbells and gym equipment in Tucson. Local delivery available.",
};
...
export default function TucsonPage() {
    return (
            ...
            <main className="min-h-screen bg-gray-50">
                <section className="bg-gradient-to-r from-purple-900 to-purple-800 text-white py-16">
                    <div className="max-w-7xl mx-auto px-4">
                        ...
                        <p className="text-xl text-purple-200 mb-6">Buy barbells in Tucson. Fast local delivery.</p>
                    </div>
                </section>
                <section className="py-12">
                    <div className="max-w-7xl mx-auto px-4 text-center">
                        <p className="mb-4">Shop the best barbells delivered to Tucson.</p>
      ...
      <section className="py-8 bg-iron-900">
        <div className="max-w-4xl mx-auto px-4">
          <h3 className="text-xl font-bold mb-4 text-white">Tucson Resources</h3>
          <div className="grid grid-cols-2 gap-4">
